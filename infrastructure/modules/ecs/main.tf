...
# ECS Module
# =============================================================================
# Creates ECS Fargate cluster and service for the Relay API
# =============================================================================
  ...
  container_definitions = jsonencode([
    {
      ...
      secrets = [
        {
          name      = "API_KEY_SECRET"
          valueFrom = "${var.secrets_arn}:API_KEY_SECRET::"
        },
        {
          name      = "WEBHOOK_SECRET"
          valueFrom = "${var.secrets_arn}:WEBHOOK_SECRET::"
        },
        {
          name      = "STRIPE_SECRET_KEY"
          valueFrom = "${var.secrets_arn}:STRIPE_SECRET_KEY::"
        },
        {
          name      = "STRIPE_WEBHOOK_SECRET"
          valueFrom = "${var.secrets_arn}:STRIPE_WEBHOOK_SECRET::"
        }
      ]
