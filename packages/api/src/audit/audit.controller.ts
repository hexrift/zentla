...
export class AuditController {
  ...
  @Get()
  @ApiOperation({ summary: 'List audit logs', description: 'List audit log entries for the workspace' })
  @ApiQuery({ name: 'limit', required: false, type: Number })
  @ApiQuery({ name: 'cursor', required: false, type: String })
  @ApiQuery({ name: 'actorType', required: false, enum: ['api_key', 'user', 'system', 'webhook'] })
