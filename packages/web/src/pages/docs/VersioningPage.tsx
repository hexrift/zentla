...
https://api.zentla.dev/api/v1/subscriptions`}</CodeBlock>
        ...
        <table className="min-w-full text-sm">
          ...
          <tbody className="divide-y divide-gray-100">
            ...
            <tr>
              ...
              <td className="py-2 text-gray-600">
                Still supported, receives security fixes only
              </td>
            </tr>
            <tr>
      ...
      <p>
        These changes are made without version bumps and are backward
        compatible:
      </p>
      <ul>
      ...
      <div className="not-prose my-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
        <p className="text-sm text-blue-800">
          <strong>Tip:</strong> Design your integration to ignore unknown fields
          in API responses. This ensures additive changes don't break your code.
        </p>
      </div>

      <h3>Breaking Changes</h3>
      <p>These changes require a new API version:</p>
      <ul>
      ...
      <p>When we deprecate functionality:</p>
      <ol>
        <li>
          <strong>Announcement:</strong> We announce the deprecation at least 3
          months in advance via changelog, email, and API response headers.
        </li>
        <li>
        ...
        <li>
          <strong>Sunset:</strong> After the deprecation period, the old version
          returns 410 Gone.
        </li>
      </ol>
...
X-Zentla-Migration: See https://zentla.dev/docs/migrations/v2`}</CodeBlock>
      ...
      <p>Our SDKs follow semantic versioning (semver):</p>
      <ul>
        <li>
      ...
      >{`// Offer with versions
{
  ...
  "versions": [
    ...
    { "id": "ov_v3", "status": "published", "publishedAt": "2025-03-01" }
      ...
      <p>Webhook payloads follow the same additive change policy:</p>
      <ul>
        ...
        <table className="min-w-full text-sm">
          ...
          <tbody className="divide-y divide-gray-100">
            <tr>
              ...
              <td className="py-2 text-gray-600">
                Production-ready, follows full deprecation process
              </td>
            </tr>
            <tr>
              <td className="py-2 pr-4">
              ...
              <td className="py-2 text-gray-600">
                Ready to use, may change with 2-week notice
              </td>
            </tr>
            <tr>
              <td className="py-2 pr-4">
      ...
      <p>
        All API changes are documented in our changelog. Subscribe to receive
        updates:
      </p>
      <ul>
        <li>
